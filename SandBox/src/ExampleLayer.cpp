	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	HEngine::Ref<HEngine::VertexBuffer> vertexBuffer = (HEngine::VertexBuffer::Create(vertices, sizeof(vertices)));
	...
	HEngine::Ref<HEngine::IndexBuffer> indexBuffer = (HEngine::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t)));
	...
	HEngine::Ref<HEngine::VertexBuffer> squareVB = (HEngine::VertexBuffer::Create(squareVertices, sizeof(squareVertices)));
	squareVB->SetLayout({
		{ HEngine::ShaderDataType::Float3, "a_Position"},
	...
	HEngine::Ref<HEngine::IndexBuffer> squareIB = (HEngine::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t)));
...
void ExampleLayer::OnUpdate(HEngine::Timestep ts)
{
	//Update
...
void ExampleLayer::OnEvent(HEngine::Event& e)
{
